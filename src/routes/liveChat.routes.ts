/*
  Routes all the sub routes of the live chat logging to their individual
...
logger.info("Managing Live chat endpoints...");
logger.debug("Creating path to live chat endpoint strategies");
const endpointsDir = path.join(__dirname, "../strategies/liveChat");
...
logger.info("Live chat router configured");
